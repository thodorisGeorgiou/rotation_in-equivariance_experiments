...
def layer(inpt, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=True, useType="test", resuse_batch_norm=False, normalize="vn", wd=0.0001):
	...
	res = cc.layers.cliffordConvPerChannelAngle(inpt, convW, c_i, c_o, s_h, s_w, padding=padding, useType=useType, num_bins=16, weightMask=weightMask, first=first)
...
def inference(images, batch_size, useType="test", first=True, resuse_batch_norm=False, fs=3, normalizationMode="bn"):
	...
	with tf.variable_scope("conv1_1", reuse=(not first)) as scope:
		...
		conv1_1_relu = layer(images, k_h, k_w, c_i, c_o, s_h, s_w, padding="VALID", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=normalizationMode, wd=wd)
		conv1 = cc.layers.normalizeVectorField(conv1_1_relu, fs, fs)
	...
	with tf.variable_scope("conv2_1", reuse=(not first)) as scope:
		...
		conv2_1 = layer(conv1, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=normalizationMode, wd=wd)
	...
	with tf.variable_scope("conv3_1", reuse=(not first)) as scope:
		...
		conv3_1 = layer(conv2_2, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=normalizationMode, wd=wd)
	...
	with tf.variable_scope("conv4_1", reuse=(not first)) as scope:
		...
		print(k_h)
		conv4_1_cart = layer(conv3_2, k_h, k_w, c_i, c_o, s_h, s_w, padding="VALID", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=normalizationMode, wd=wd)
	...
	with tf.variable_scope("fc1", reuse=(not first)) as scope:
		...
		fc1_cart = layer(conv4_1_cart, k_h, k_w, c_i, c_o, s_h, s_w, padding="VALID", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=normalizationMode, wd=wd)
	...
	with tf.variable_scope("fc2", reuse=(not first)) as scope:
		...
		fc2_cart = layer(fc1_cart, k_h, k_w, c_i, c_o, s_h, s_w, padding="VALID", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=normalizationMode, wd=wd)
