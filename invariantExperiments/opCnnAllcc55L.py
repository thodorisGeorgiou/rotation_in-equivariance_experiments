...
def layer(inpt, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=True, useType="test", resuse_batch_norm=False, normalize="bn", wd=0.0001):
...
def inference(images, batch_size, useType="test", first=True, resuse_batch_norm=False, fs=3, normalizationMode="bn"):
	...
	with tf.variable_scope("conv1_1", reuse=(not first)) as scope:
		...
		conv1_1_relu, angles_1_1 = layer(images, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=False, wd=wd)
	...
	with tf.variable_scope("conv2_1", reuse=(not first)) as scope:
		...
		conv2_1_relu, angles_2_1 = layer(conv1, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=False, wd=wd)
	...
	with tf.variable_scope("conv2_2", reuse=(not first)) as scope:
		...
		conv2_2_relu, angles_2_2 = layer(conv2_1, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=False, wd=wd)
	...
	with tf.variable_scope("conv3_1", reuse=(not first)) as scope:
		...
		conv3_1_relu, angles_3_1 = layer(conv2_2, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=False, wd=wd)
	...
	with tf.variable_scope("conv3_1.5", reuse=(not first)) as scope:
		...
		conv3_15_relu, angles_3_15 = layer(conv3_1, k_h, k_w, c_i, c_o, s_h, s_w, padding="SAME", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=False, wd=wd)
	...
	with tf.variable_scope("conv4_1", reuse=(not first)) as scope:
		...
		conv4_1_relu, angles_4_1 = layer(conv3_2, k_h, k_w, c_i, c_o, s_h, s_w, padding="VALID", first=first, useType=useType, resuse_batch_norm=resuse_batch_norm, normalize=False, wd=wd)
