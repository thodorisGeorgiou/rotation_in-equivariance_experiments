...
# baseDir = "trained_55L/opNet5L3x96_64_2x36_32_16_fs_9_all_7_16Bins_floatMaskOnBias_withMultipliers_weightMask_weightToThetaGradsAll_normAllLayers_onlyLBnOnMagnBeforeReLU_trainAll_dropout_0.2_0MAD_droppingLR_30_testValMethod_"+run+"_"
baseDir = "trained_complexWeights/grSumCc5L3x96_64_2x36_32_16_fs_9_all_7_16Bins_floatMaskOnBias_weightMask_normAllLayers_onlyLBnOnMagnBeforeReLU_glVecNorm_trainAll_dropout_0.2_0MAD_droppingLR_30_testValMethod_MaxConv0_"+run+"_"
...
if __name__ == '__main__':
	...
	[next_example, next_label], [next_testExample, next_testLabel], [trainIterator, testIterator] = preprocessing.colorInput(batch_size, mnsitTrain['x'].reshape([12000,28,28,1]), mnsitTrain['y'].reshape([12000,1]), testBatch_size=testBatch_size)
